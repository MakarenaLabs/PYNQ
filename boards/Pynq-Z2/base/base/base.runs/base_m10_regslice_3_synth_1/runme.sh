...
HD_PWD='/home/pynq/workspace/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_m10_regslice_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_m10_regslice_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_m10_regslice_3.tcl
