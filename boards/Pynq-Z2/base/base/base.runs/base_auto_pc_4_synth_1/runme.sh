...
HD_PWD='/home/pynq/workspace/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_auto_pc_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_auto_pc_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_auto_pc_4.tcl
